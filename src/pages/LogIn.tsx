...
const LogIn = () => {
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="text-lg flex-center flex-col py-12 px-24 shadow-lg rounded-lg">
      ...
      <button type="submit" className="bg-sky-400 my-4 shadow rounded py-1 px-4 text-white active:bg-sky-500 font-semibold">Sign up</button>

      <div className="text-sm">Do not Have Account? <Link to="/auth/signup" className="text-blue-500 underline">Log in</Link></div>
